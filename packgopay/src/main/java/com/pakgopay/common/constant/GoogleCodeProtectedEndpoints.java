...
public final class GoogleCodeProtectedEndpoints {
    ...
    static {
        ...
        map.put("POST /pakGoPay/server/SystemConfig/config", "update system config");
        map.put("POST /pakGoPay/server/SystemConfig/telegramBroadcast", "telegram broadcast");
        ...
        map.put("POST /pakGoPay/server/merchant/resetMerchantSignKey", "reset merchant sign key");
        ...
        map.put("POST /pakGoPay/server/CurrencyTypeManagement/syncCurrencyType", "sync currency type");
